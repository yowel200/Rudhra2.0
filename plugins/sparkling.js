...
const need = "Command Kazhinn Yanthankilum Eyuth chunke\n🙄🙄🙄"
...
if (Config.WORKTYPE == 'private') {
  ...
  Asena.addCommand({ pattern: 'sparkling ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    var ttinullimage = await axios.get(`https://docs-jojo.herokuapp.com/api/sparkling?text1=${encodeURIComponent(match[1])}&text2=Rudhra`, { responseType: 'arraybuffer' })
