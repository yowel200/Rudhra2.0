...
if (Config.WORKTYPE == 'private') {
  ...
  Asena.addCommand({ pattern: 'leavest ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    var ttinullimage = await axios.get(`https://api.zeks.xyz/api/leavest?apikey=Upe1Fp1lDAtX0ioPYLEPsSoX51i&text1=RUDHRA&text2=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
