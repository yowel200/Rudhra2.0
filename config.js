...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ ᴘʀɪɴᴄᴇʀᴜᴅʜ' : process.env.ALL_CAPTION,
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'ᴘʀɪɴᴄᴇʀᴜᴅʜ' : process.env.OWNER_NAME,
