...
module.exports = {
    ...
    MENTION: process.env.TAG_REPLY === undefined ? '918592068706@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTNAME: process.env.BOT_NAME === undefined ? '  ☚⃟፝༄ᴛᴏxɪᴄ ᴀʟᴇxᴀ☚⃟፝࿐  \n\n   *ʙᴏᴛ™*   \n' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '✮⃝🎸ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ sᴏɴɢ✮⃝🎧' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '✮⃝🎸ᴜᴘʟᴏᴀᴅɪɴɢ sᴏɴɢ✮⃝🎧' : process.env.SONGU,
    ...
    YAK: process.env.YAK === undefined ? '918592068706,0' : process.env.YAK,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? '☚⃟፝༄ᴛᴏxɪᴄ ᴀʟᴇxᴀ☚⃟፝࿐' : process.env.LOGO_NAME,
